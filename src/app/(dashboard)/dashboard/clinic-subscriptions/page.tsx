  ...
  return (
    <div className="container mx-auto space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Clinic Platform Subscriptions</h1>
          <p className="text-muted-foreground">
            Manage subscription pricing for clinics by country
          </p>
        </div>
          ...
          subscriptions.map((subscription) => (
            <Card key={subscription.id} className="relative overflow-hidden">
              ...
              <CardHeader>
                ...
                <CardDescription>Clinic Platform Subscription</CardDescription>
              </CardHeader>
